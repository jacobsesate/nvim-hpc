...
curl -LO [https://github.com/neovim/neovim/releases/download/v0.10.4/nvim-linux-x86_64.tar.gz](https://github.com/neovim/neovim/releases/download/v0.10.4/nvim-linux-x86_64.tar.gz)
...
After the "fasd" stuff I also included a few useful aliases that I use specifically for the HPC to quickly spin up an interactive node with some resources:
